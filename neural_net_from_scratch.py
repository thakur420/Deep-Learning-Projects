...
- [Introduction](#0)
- [1 - Packages](#1)
- [2 - Parameter Initialization](#2)
- [3 - Activation Methods & Its Derivative](#3)
- [4 - Forward Propagation](#4)
- [5 - Compute Cost/Loss](#5)
- [6 - Backward Propagation](#6)
- [7 - Update parameter](#7)
- [8 - Neural Network Implementation](#8)
- [9 - NN Model Training and Testing](#9)
- [Conclusion](#10)

# Simple Neural Network Implementation from Scratch

This notebook provides a step-by-step guide to building a simple Multi-Layer Perceptron (MLP) neural network from the ground up, without relying on high-level deep learning libraries like TensorFlow or PyTorch. The goal is to understand the fundamental concepts of neural networks, including:

*   **Forward Propagation:** How data flows through the network to generate predictions.
*   **Backward Propagation:** How the network calculates gradients to adjust weights and biases.
*   **Parameter Updates:** Using optimization algorithms like Gradient Descent, Momentum, and Adam.
*   **Activation Functions:** Implementing sigmoid, ReLU, and tanh.
*   **Regularization Techniques:** Incorporating L2 regularization and Dropout to combat overfitting.

The notebook also demonstrates how to apply this implemented neural network to solve binary classification problems using the **CIFAR-10**, **Pima Indians Diabetes dataset**, and **Breast Cancer** datasets, evaluating its performance on each.
